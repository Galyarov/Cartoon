    ...
    for(double z = 0; z<=20; z++)
        {
         ...
         if (z <= 7)
          {
           for(double a = 0; a<=5; a++)//поднимает руки
            {
             Boy(x, y, size, 5, mah);
             mah = mah - a;
             txSleep(100);
         ...
         if (z >= 8)
          {
           for(double a1 = 0; a1<=5; a1++)//опускает руки
            {
             Boy(x, y, size, 5, mah);
             mah = mah + 1;
             ...
             if (z == 20)
              {
               for(double a2 = 0; a2<=10; a2++)//уходит
                {
                 Boy(x, y, size, 5, mah);
                 x = x + 2*a2;
                 //size = size + 1,5*a2;
...
void Bird (long xb, long yb, int ras, double sizeb)
    ...
    POINT body [4] {{xb, yb           },  {xb + 100*sizeb, yb - 50*sizeb},
    ...
    POINT krilo2 [4] {{xb - 20*sizeb, yb           },  {xb + 20*sizeb, yb            },
                      {xb - 40*sizeb, yb + 100*sizeb}, {xb + 40*sizeb, yb + 100*sizeb}};
    txPolygon        (krilo2, 4);
...
void Snowman(long xs, long ys, int nac,  double stick, double sizes)
    ...
    POINT carrot [4] {{xs, ys - 60*sizes}, {xs + 30*sizes, ys - 50*sizes},
...
void Kolobok (long xk, long yk, int    rot,  int    rad,   double sizek)
    ...
    txSetColor     (TX_BLACK);
    txSetFillColor (TX_BROWN);
    POINT nos [4]  {{xk          ,  yk           }, {xk - 20*sizek, yk + 20*sizek},
    ...
    POINT GG [5]   {{xk - 15*sizek, yk - 15*sizek}, {xk - 10*sizek, yk - 10*sizek},
                    {xk - 13*sizek, yk -  7*sizek}, {xk - 18*sizek, yk - 12*sizek},
