...
//------Phrase 1
    ...
    txSetColor   (RGB(0, 0, 0));
    txSelectFont ("Comic Sans MS", 50);
    txTextOut    (500, 300, "-Oh, who will help me.");
...
//------Phrase 2
    ...
    txSetColor   (RGB(0, 0, 0));
    txSelectFont ("Comic Sans MS", 50);
    txTextOut    (300, 300, "-Kolobok, why are you sad?");
    txTextOut    (300, 400, "-Yes, here's a splinter, but I can't get it");
    txTextOut    (300, 500, "-Let me help you");
...
//-------Action 3
    ...
    long xKolobokStandart = xKolobok;
    long yKolobokStandart = yKolobok;
    long xZanoza = ROUND(x + 100*size + mah*size);
    long yZanoza = ROUND(y + 200*size - mah*size);
    ...
    txSetColor   (RGB(0, 0, 0));
    txSelectFont ("Comic Sans MS", 50);
    txTextOut    (300, 300, "-Here's a thank you man");
